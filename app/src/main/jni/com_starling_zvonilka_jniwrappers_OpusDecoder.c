#include <com_starling_zvonilka_jniwrappers_OpusDecoder.h>
#include <string.h>
...
JNIEXPORT jboolean JNICALL Java_com_starling_zvonilka_jniwrappers_OpusDecoder_nativeInitDecoder (JNIEnv *env, jobject obj, jint samplingRate, jint numberOfChannels, jint frameSize)
{
...
JNIEXPORT jint JNICALL Java_com_starling_zvonilka_jniwrappers_OpusDecoder_nativeDecodeBytes (JNIEnv *env, jobject obj, jbyteArray in, jshortArray out)
{
...
JNIEXPORT jboolean JNICALL Java_com_starling_zvonilka_jniwrappers_OpusDecoder_nativeReleaseDecoder (JNIEnv *env, jobject obj)
{
    free(dec);
